...
const bonusCards = ref([
  {
    ...
    description: 'сделай депозит от 20000 рублей и получи бонус + 200% к депозиту 200 ФС. Персональный реф-код на 20% от суммы пополнения твоих друзей!',
    wager: 'вейджер х1',
  ...
  },
  {
    img: 'bon2.png',
    title: 'СУПЕР БОНУС',
    description: 'сделай депозит от 10000 рублей и получи бонус 150% к депозиту и 150 ФС',
    wager: 'вейджер х3',
  ...
  },
  {
    img: 'bon3.png',
    title: 'ПОЛУЧИ БОНУС',
    description: 'сделай депозит от 5000 рублей и получи 100% к депозиту 100 ФС',
    wager: 'вейджер х5',
    buttonText: 'Получить бонус'
  }
]);
